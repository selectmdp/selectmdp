...
def train(save_path):
    ...
    fcsv_rad, csv_rad = open_csv(save_path+'rad')
    ...
    for seed in range(4):
        ...
        for input_num in INPUT_LIST:
            for output_num in OUTPUT_LIST:
                path = FLAGS.ENVIRONMENT+'/csv_result/'+str(input_num) + '_' + str(output_num)+ '.csv'
                FLAGS.N_INPUT = input_num
                FLAGS.N_EQUIVARIANT = output_num
